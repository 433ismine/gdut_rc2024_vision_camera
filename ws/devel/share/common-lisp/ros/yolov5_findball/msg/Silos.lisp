...
(cl:defmethod cl:initialize-instance :after ((m <Silos>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Silos)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolov5_findball-msg:<Silos> is deprecated: use yolov5_findball-msg:Silos instead.")))

(cl:ensure-generic-function 'Silos_data-val :lambda-list '(m))
(cl:defmethod Silos_data-val ((m <Silos>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5_findball-msg:Silos_data-val is deprecated.  Use yolov5_findball-msg:Silos_data instead.")
  (Silos_data m))
