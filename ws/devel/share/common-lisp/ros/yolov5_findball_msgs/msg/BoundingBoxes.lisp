...
(cl:defclass <BoundingBoxes> (roslisp-msg-protocol:ros-message)
  ((header
   ...
   (bounding_boxes
    ...
    :type (cl:vector yolov5_findball_msgs-msg:BoundingBox)
   :initform (cl:make-array 0 :element-type 'yolov5_findball_msgs-msg:BoundingBox :initial-element (cl:make-instance 'yolov5_findball_msgs-msg:BoundingBox))))
)
...
(cl:defmethod cl:initialize-instance :after ((m <BoundingBoxes>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'BoundingBoxes)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name yolov5_findball_msgs-msg:<BoundingBoxes> is deprecated: use yolov5_findball_msgs-msg:BoundingBoxes instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5_findball_msgs-msg:header-val is deprecated.  Use yolov5_findball_msgs-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'image_header-val :lambda-list '(m))
(cl:defmethod image_header-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5_findball_msgs-msg:image_header-val is deprecated.  Use yolov5_findball_msgs-msg:image_header instead.")
  (image_header m))

(cl:ensure-generic-function 'bounding_boxes-val :lambda-list '(m))
(cl:defmethod bounding_boxes-val ((m <BoundingBoxes>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader yolov5_findball_msgs-msg:bounding_boxes-val is deprecated.  Use yolov5_findball_msgs-msg:bounding_boxes instead.")
  (bounding_boxes m))
...
(cl:defmethod roslisp-msg-protocol:deserialize ((msg <BoundingBoxes>) istream)
  ...
  (cl:let ((vals (cl:slot-value msg 'bounding_boxes)))
    ...
    (cl:setf (cl:aref vals i) (cl:make-instance 'yolov5_findball_msgs-msg:BoundingBox))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<BoundingBoxes>)))
  ...
  "yolov5_findball_msgs/BoundingBoxes")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'BoundingBoxes)))
  "Returns string type for a message object of type 'BoundingBoxes"
  "yolov5_findball_msgs/BoundingBoxes")
