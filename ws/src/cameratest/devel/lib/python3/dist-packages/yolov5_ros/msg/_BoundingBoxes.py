...
"""autogenerated by genpy from yolov5_ros/BoundingBoxes.msg. Do not edit."""
import codecs
import sys
...
"""
  ...
  _slot_types = ['std_msgs/Header','std_msgs/Header','yolov5_ros/BoundingBox[]']
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      for i in range(0, length):
        val1 = yolov5_ros.msg.BoundingBox()
        _x = val1
        start = end
        end += 42
